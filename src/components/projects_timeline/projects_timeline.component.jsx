...
import L_EasyFarm from "../../assets/img/projects/Capture.PNG";
            ...
            <Timeline>
                ...
                <ImageEvent date="22/09/2020" className="text-center" text="Evernote Clone" src={L_GetGitHubInfo} alt="Get GitHub Info">
                    ...
                    <div className="d-flex justify-content-between flex-nowrap text-center">
                        ...
                        <UrlButton href="https://github.com/saksham9/Myportfolio" target="_blank">
                        SOURCE CODE
                        </UrlButton>
                    </div>
                    </div>
                ...
                {/* Farmer portal */}
                <ImageEvent date="1/10/2020" className="text-center" text="EasyFarm" src={L_EasyFarm} alt="EasyFarm">
                    <div className="d-flex justify-content-between flex-column mt-1">
                    <div>
                        <Accordion>
                        <Card>
                    ...
                    <div className="d-flex justify-content-between flex-nowrap text-center">
                        ...
                        <UrlButton href="https://github.com/saksham9/EasyFarm" target="_blank">
                        SOURCE CODE
                        </UrlButton>
                    </div>
                    </div>
