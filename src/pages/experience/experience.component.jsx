...
import L_ACCENTURE from "../../assets/img/experience/Infosys.svg";
        ...
        <Tilt options={{ max: 25 }}>
            <Card>
              ...
              <Card.Body className="d-flex justify-content-center flex-column">
                <div>
                  <Card.Title className="text-center">System Engineer</Card.Title>
                </div>
                <div>
                  <Card.Text className="text-center style">
                    ...
                    <br />
                    <strong>Duration:</strong> February 2017 - October 2018
                  </Card.Text>
                </div>
              </Card.Body>
            </Card>
